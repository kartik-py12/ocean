          ...
          <div className="flex items-center space-x-4">
            {user ? (
              <>
                ...
                <button onClick={() => onNavigate(Page.PROFILE)} className="text-sm bg-red-500 hover:bg-green-300 text-white font-semibold px-4 py-2 rounded-lg transition-colors">Profile</button>
              </>
            ) : (
              <>
